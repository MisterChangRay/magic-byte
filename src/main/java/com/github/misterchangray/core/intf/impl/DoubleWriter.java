 ...
 **/
public class DoubleWriter extends MWriter {
    public DoubleWriter(FieldMetaInfo _fieldMetaInfo) {
    ...
    @Override
    public void doWriteToBuffer(DynamicByteBuffer buffer, Object val, Object parent) {
